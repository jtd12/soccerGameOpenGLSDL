...
game::game()
{
	 ...
	 screenHeight=540;
		...
		TTF_Init();
        screen=SDL_SetVideoMode (screenWidth, screenHeight,32,SDL_OPENGL|SDL_SWSURFACE);
...
//SDL_ShowCursor(SDL_DISABLE);
  ...
  unsigned int ball_=obj.load("data/balle.obj",&mapcp);
   ...
   ball=new balle("balle",ball_,collisionsphere(vector3d(0,15,0),0.8),2.1f);
 ...
 joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(0,10,30),3.5)));
 joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(0,10,32),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(0,10,35),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(0,10,37),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,39),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,21),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,25),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,27),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,28),3.5)));
  joueur.push_back(new player(anim,rand.random(0.05,0.1),collisionsphere(vector3d(10,10,29),3.5)));
  anim.clear();
   obj.loadAnimation(anim2, "data/playerAI/playerAI",25);
    joueurAI.push_back(new playerAI(anim2,0.1,collisionsphere(vector3d(5,10,0),3.5)));
 joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,20),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,25),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,23),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,22),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,24),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,26),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,28),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,21),3.5)));
  joueurAI.push_back(new playerAI(anim2,rand.random(0.05,0.2),collisionsphere(vector3d(20,10,29),3.5)));
  anim2.clear();
   obj.loadAnimation(anim3, "data/goalA/goalA",36);
  goal_.push_back(new goal(anim3,0.1,collisionsphere(vector3d(-45,10,0),3.5)));
   
  anim3.clear();
 obj.loadAnimation(anim4, "data/goalA/goalA",36);
  goal_.push_back(new goal(anim4,0.1,collisionsphere(vector3d(45,10,0),3.5)));
